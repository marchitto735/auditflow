...
function DialogClose({
  ...
  return (
    <DialogPrimitive.Close
      ...
      className={cn(
        "ring-offset-background focus-visible:ring-ring rounded-sm opacity-70 transition-opacity hover:opacity-100 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none disabled:pointer-events-none",
        className
      )}
      aria-label="Close"
      {...props}
  ...
  return (
    <DialogPortal container={portalContainer}>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          centerInViewport
            ...
            : "bg-white dark:bg-background color:bg-background data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 fixed inset-0 z-50 flex flex-col w-full h-full max-w-none max-h-none rounded-none duration-200 md:left-[50%] md:top-[50%] md:right-auto md:bottom-auto md:translate-x-[-50%] md:translate-y-[-50%] md:h-auto md:max-w-[500px] md:rounded-2xl lg:max-w-[600px]",
      ...
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            className="ring-offset-background focus-visible:ring-ring absolute right-4 top-4 rounded-sm opacity-70 transition-opacity hover:opacity-100 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none disabled:pointer-events-none"
            aria-label="Close"
          >
